...
// Maximum rects and animations
// Ca be redefined if needed
#define MAX_ANIMS     (4)
...
** Entity data
****************************************/
// Method type for actions triggered by game events
...
typedef struct game_scene {
    ...
    void (*update)(struct game_scene**); // Scene updater
} scene_t;
