...
** My Hunter
** File description:
** Defaults for global game env variables
*/
...
const sfTexture *TEXTURE_DUCK = NULL;

const sfIntRect TEXTRECT_DUCK = {
    .left = 0,
    .top = 119,
    .width = 113,
    .height = 148,
...
const sfIntRect ANIMRECTS_DUCK[][ANIM_DUCK_COUNT] = {
    ...
    [ANIM_DUCK_DIAGONAL] = {
        ...
        {.left = 41, .top = 39, .width = 27, .height = 23},
        {.left = 83, .top = 38, .width = -1, .height = -1},
        {.left = -1, .top = -1, .width = -1, .height = -1},
    },
    [ANIM_DUCK_VERTICAL] = {
        {.left = -1, .top = -1, .width = -1, .height = -1},
...
const entity_t ENT_DUCK = {
    ...
    .spinfo = {
        ...
        .anims = {
            ...
            .rects = (sfIntRect **) ANIMRECTS_DUCK,
...
void init_defaults_duck(void)
{
    static sfTime tock = {0};

    tock = sfMilliseconds(2);
    TEXTURE_DUCK = sfTexture_createFromFile(TEXTURE_DUCK_PATH, &TEXTRECT_DUCK);
    TOCK_DUCK = &tock;
}
